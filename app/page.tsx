            ...
            {[
              {
                ...
                desc: "Бизнесийнхээ талаар 8 асуулт хариулна — Builder AI тань үлдсэн бүгдийг хийнэ. Мэдлэгийн сан, persona, хариултын загвар автоматаар үүснэ. Программист, агенци хэрэггүй.",
              },
              {
                badge: "QPay интеграц",
                icon: "💳",
                title: "Чат дотроос захиалга авч, дансандаа шууд авна",
                desc: "Хэрэглэгч Messenger-т захиалга өгмөгц AI автоматаар QPay QR явуулна. Төлбөр шууд таны дансанд орно — манайхаар дамжихгүй, шимтгэлгүй.",
              },
              {
                badge: "+1 → DM автомат",
                icon: "🎯",
                title: "Comment бүрийг боломж болгоно",
                desc: "Facebook постод '+1' гэж бичсэн хэрэглэгч бүрт автоматаар DM явна. Viral пост дээр ч зардал бараг $0 — OpenAI дуудахгүй, зөвхөн шаблон ашиглана.",
              },
              {
                badge: "Хүний handoff",
                icon: "🤝",
